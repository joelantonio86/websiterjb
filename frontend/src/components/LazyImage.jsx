    ...
    <div className={`relative overflow-hidden ${className}`}>
      ...
      {!isLoaded && !hasError && (
        <div className="absolute inset-0 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 animate-pulse flex items-center justify-center">
          <svg className="w-8 h-8 text-rjb-text-muted dark:text-rjb-text-muted-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {hasError && (
        <div className="absolute inset-0 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center">
          <div className="text-center p-4">
            <svg className="w-8 h-8 text-rjb-text-muted dark:text-rjb-text-muted-dark mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
            <p className="text-xs text-rjb-text-muted dark:text-rjb-text-muted-dark">Erro ao carregar</p>
          </div>
        </div>
      )}
    </div>
