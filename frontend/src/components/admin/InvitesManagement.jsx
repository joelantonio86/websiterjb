      ...
      <div className="p-5 sm:p-6 space-y-4">
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <button
              onClick={copyKey}
              className="absolute right-2 top-1/2 -translate-y-1/2 p-2.5 sm:p-2 text-rjb-text/50 hover:text-rjb-yellow transition-colors rounded-lg hover:bg-rjb-yellow/10"
              title="Copiar chave"
            >
        ...
        <p className="text-[11px] sm:text-xs text-rjb-text/60 dark:text-rjb-text-dark/60">A chave é copiada automaticamente quando gerada.</p>
        
        {showWhatsApp && generatedKey && (
          <button
            onClick={shareViaWhatsApp}
            className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold py-4 sm:py-3.5 rounded-xl flex items-center justify-center gap-3 transition-all shadow-lg hover:shadow-xl transform hover:scale-[1.02] text-sm sm:text-base"
          >
